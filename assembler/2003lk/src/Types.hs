...
data Instruction = TERMINATE | Krz Rvalue Lvalue | Krz8i Rvalue Lvalue | Krz8c Rvalue Lvalue | Krz16i Rvalue Lvalue | Krz16c Rvalue Lvalue | Ata Rvalue Lvalue | Nta Rvalue Lvalue | Ada Rvalue Lvalue | Ekc Rvalue Lvalue | Dal Rvalue Lvalue | Dto Rvalue Lvalue | Dro Rvalue Lvalue | Dtosna Rvalue Lvalue | Lat Rvalue Lvalue Lvalue | Latsna Rvalue Lvalue Lvalue | MalKrz Rvalue Lvalue | Fi Rvalue Rvalue Cond | Inj Rvalue Lvalue Lvalue deriving (Show, Eq, Ord)  
